...
public interface CartItemRepository extends JpaRepository<CartItem, Long>{
    ...
    // Custom query to find a Product associated with a CartItem based on the product's ID
...
//	List<Cart> findCartsByProductId(Long productId);
    ...
    // Custom query to find a CartItem by both the Cart ID and the Product ID
...
//	Order findOrderByEmailAndOrderId(String email, Integer orderId);
    ...
    // Custom query to delete a CartItem by Cart ID and Product ID
    // The @Modifying annotation is necessary because this method modifies data (i.e., it deletes a record)
    @Modifying
